...
<template>
  <div class="space-y-6 p-4">
    <h1 class="text-2xl font-bold">Manage Entity {{ entityData?.name }}</h1>

    <!-- Entity Loader/Error -->
    <div v-if="entityPending" class="py-8 text-center">Loading entity…</div>
            ...
            <table class="mt-3 w-full text-left">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="pt-1">{{ formatValue(entityData[key]) }}</td>
