...
async function handleSubscriptionEvent(data: Stripe.Subscription): Promise<any> {
...
async function handleCheckoutSessionEvent(data: Stripe.Checkout.Session): Promise<void> {
